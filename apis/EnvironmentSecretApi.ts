...
export class EnvironmentSecretApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param secretId Secret ID
     */
    public async deleteEnvironmentSecret(environmentId: string, secretId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'environmentId' is not null or undefined
        if (environmentId === null || environmentId === undefined) {
            throw new RequiredError("EnvironmentSecretApi", "deleteEnvironmentSecret", "environmentId");
        }


        // verify required parameter 'secretId' is not null or undefined
        if (secretId === null || secretId === undefined) {
            throw new RequiredError("EnvironmentSecretApi", "deleteEnvironmentSecret", "secretId");
        }
...
export class EnvironmentSecretApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteEnvironmentSecret
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteEnvironmentSecret(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
