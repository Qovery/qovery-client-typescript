 ...
 * no description
 */
export class ProjectMainCallsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async deleteProject(projectId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (projectId === null || projectId === undefined) {
            throw new RequiredError("ProjectMainCallsApi", "deleteProject", "projectId");
        }
     ...
     */
    public async editProject(projectId: string, projectRequest?: ProjectRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'projectId' is not null or undefined
        if (projectId === null || projectId === undefined) {
            throw new RequiredError("ProjectMainCallsApi", "editProject", "projectId");
        }
    ...
    public async getProject(projectId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'projectId' is not null or undefined
        if (projectId === null || projectId === undefined) {
            throw new RequiredError("ProjectMainCallsApi", "getProject", "projectId");
        }
...
export class ProjectMainCallsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to editProject
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async editProject(response: ResponseContext): Promise<ProjectResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
